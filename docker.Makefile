...
build:
	$(DOCKER_BUILD) -t printesoi/docker-github-actions-default --build-arg MAKE_TARGET=default .

image:
	$(DOCKER_BUILD) -t printesoi/docker-github-actions:$(TAG) --build-arg MAKE_TARGET=build .
